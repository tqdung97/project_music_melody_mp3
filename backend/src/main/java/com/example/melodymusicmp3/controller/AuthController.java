package com.example.melodymusicmp3.controller;

import com.example.melodymusicmp3.entity.*;
import com.example.melodymusicmp3.security.JwtResponse;
import com.example.melodymusicmp3.service.IUserDetailService;
import com.example.melodymusicmp3.service.IUserService;
import com.example.melodymusicmp3.service.JwtService;
...
public class AuthController {
    ...
    public ResponseEntity<Customer> register(@RequestBody Customer customer){
        if (customer != null){
            ...
            userDetails.setNumberPhone(customer.getNumberPhone());
    ...
    public ResponseEntity<UserDetail> editProfile(@PathVariable String username, @RequestBody Customer customer){
        ...
        userDetailOld.setNumberPhone(customer.getNumberPhone());
